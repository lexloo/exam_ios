...
class SelectCategoryController: SingleSelectorViewController {
...
extension SelectCategoryController: SelectDataSource {
    func getItemData() -> [SelectItem]? {
        return [SelectItem(guid: "61AEAB78A7CD3671E050840A063959A8", name: "医师资格"), SelectItem(guid: "61AEAB78A7CE3671E050840A063959A8", name: "卫生资格")]
    }
}
//    @objc func close() {
